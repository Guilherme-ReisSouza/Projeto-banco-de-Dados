...
db.createCollection("teaches_takes");
db.teaches_takes.createIndex({"ID_student": 1,"ID_prof": 1,"course_id": 1,"sec_id": 1,"semester": 1,"year": 1,"grade": 1
}, { unique: true });
...
// Depois de instanciar todos os documentos, podemos inserir os dados em qualquer ordem. Para inserir os dados, colocamos os parâmetros em
// ordem de index para cada documento inserido. A função insertMany permite inserirmos mais de um doc de uma vez


//classroom_section
db.classroom_sections.insertMany([
  {
